...
function Privacy() {
  ...
  return (
    <div style={containerStyle}>
      <div className="box">
        <h1 style={{...h1Style, color: 'black'}}>Privacy Policy - Jasmin Privacy Statement</h1>
        <p style={pStyle}>
      ...
      <div className="box">
        ...
        <p style={pStyle}>
          ...
          Jasmin, please email <a href="mailto:lachicafenella@gmail.com">jasminhealth@jasmin.com</a>.
        </p>
      </div>
      <div className="box">
