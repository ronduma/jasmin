...
function BasicSearch({ selectedApproach, setSelectedApproach, selectedGender, setSelectedGender, selectedPrice, setSelectedPrice, selectedSort, setSelectedSort }) {
  return (<>
